...
RAW D021 versus RAW Qwen3-Embedding 0.6B had identical reranked hit/recall/MRR (`1.000/1.000/0.873`) and identical answer/citation/unsupported metrics (`0.833/1.000/0.167`). Qwen was materially more expensive locally: retrieval p95 `510.03 ms` versus `232.85 ms`, 1024 versus 384 dimensions, and approximately `1066 MiB` versus `140 MiB` process RSS growth. Pack isolation, current top-1 superseded leakage, lifecycle/lineage target checks for the compared reranked routes, poisoning/context security, citation identity, and all 189 receipt schema validations passed. The stale-before-relevant ranking diagnostic remained visible and was not promoted to authority.
