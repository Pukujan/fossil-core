...
The matched RAW reranked D021 and Qwen3-Embedding 0.6B routes both achieved hit rate `1.000`, recall@5 `1.000`, MRR `0.873`, answer correctness `0.833`, citation correctness `1.000`, and unsupported-claim rate `0.167`. Qwen's retrieval p95 was `510.03 ms` versus `232.85 ms` for D021, with approximately `1066 MiB` versus `140 MiB` process RSS growth. The 189 receipt sidecar validated fully; pack isolation, top-1 superseded leakage, lifecycle/lineage checks on the compared routes, and the shared poisoning/context-security control passed.
